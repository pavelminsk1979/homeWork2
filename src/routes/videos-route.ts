...
videosRoute.get('/:id', (req: RequestWithParams<Param>, res: Response) => {
...
videosRoute.put('/:id', (req: RequestWithParamsWithBody<Param, PutVideo>, res: Response) => {
    const errors: ErrorType = {errorsMessages: []}
...
videosRoute.delete('/:id', (req: RequestWithParams<Param>, res: Response) => {
